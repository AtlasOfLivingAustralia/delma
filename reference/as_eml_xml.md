...
`xml_document`, as defined by the `xml2` package. When converting from a
list, this is simply a wrapper for
[`xml2::as_xml_document()`](http://xml2.r-lib.org/reference/as_xml_document.md).
