...
<!--
This is a metadata template in .Rmd format. 

This template has been formatted to render as an html document (set in the 
yaml `output` above) AND to Ecological Metadata language (EML) using the 
...
# which expects a valid DOI. To use a different UUID system, change the 
# 'system' param _and_ the `packageId`.
list(
