...
The inverse operation - converting an .xml file with EML content into .md - is 
also possible. This can work from an xml file in your working directory, or
from a URL to a valid EML document:
